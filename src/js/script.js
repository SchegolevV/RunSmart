...
$(document).ready(function(){
    ...
    $('.slider__inner').slick({
        ...
        prevArrow: '<button type="button" class="slick-prev"><img src="src/icons/list-four/chevron-left-solid.svg"></img></button>',
        nextArrow: '<button type="button" class="slick-next"><img src="src/icons/list-four/chevron-right-solid.svg"></img></button>',
        responsive: [
            {
                breakpoint: 992,
                settings: {
